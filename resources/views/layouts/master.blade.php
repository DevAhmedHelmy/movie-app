        ...
        <nav class="border-b border-gray-800">
            <div class="container flex flex-col items-center justify-between px-4 py-4 mx-auto md:flex-row">
                ...
                <div class="flex flex-col items-center md:flex-row">
                    ...
                    {{--  <div class="relative md:ml-4 md:mt-0">
                        <input type="text" class="w-64 px-2 py-2 pl-8 text-sm bg-gray-800 rounded-full focus:outline-none focus:shadow-outline" placeholder="Search">
                    ...
                    <div class="mt-3 md:ml-4 md:mt-0">
                        <img src="{{ asset('img/avatar.png') }}" class="w-8 h-8 " alt="">
                    </div>
                </div>
            </div>
