...
@section('content')
    <div class="border-b border-gray-800 movie-info">
        <div class="container flex flex-col px-4 py-16 mx-auto md:flex-row">
            <img src="{{ 'https://image.tmdb.org/t/p/w500/'.$movie['poster_path'] }}" class="w-64 transition duration-150 ease-in-out hover:opacity-75 md:w-96" alt="">
            <div class="md:ml-24">
                ...
                <div x-data="{isOpen:false}">
                    @if($movie['videos']['results'] > 0)
                        <div class="mt-12">
                            <button
                            @click="isOpen=true"
                             href="https://youtube.com/watch?v={{ $movie['videos']['results'][0]['key'] }}" class="flex inline-flex items-center px-5 py-4 font-semibold text-gray-900 transition duration-200 ease-in-out bg-orange-500 rounded hover:bg-orange-800">
