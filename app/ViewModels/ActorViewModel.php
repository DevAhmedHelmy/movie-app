...
class ActorViewModel extends ViewModel
{
    ...
    public function actor()
    {
        return collect($this->actor)->merge([
            ...
            'name', 'id', 'birthday', 'deathday', 'place_of_birth', 'profile_path','also_known_as','biography','age','homepage'
    ...
    {
        $castMovies = collect($this->credits)->get('cast');
        return collect($castMovies)->where('media_type','movie')->map(function($movie){
